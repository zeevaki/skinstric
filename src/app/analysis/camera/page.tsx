      ...
      {ready && (
        <>
          ...
          {captured ? (
            ...
            <div onClick={handleTakePicture} className="absolute z-[3] cursor-pointer select-none flex items-center gap-3" style={{ right: 32, top: "50%", transform: "translateY(-50%)", opacity: countdown !== null ? 0.4 : 1 }}>
              <span style={{ fontSize: 10, fontWeight: 600, letterSpacing: "-0.02em", textTransform: "uppercase", color: "#FCFCFC", opacity: 0.7 }}>Take Picture</span>
              <div style={{ width: 56, height: 56, borderRadius: "50%", background: "#FCFCFC", border: "2px solid #FCFCFC", display: "flex", alignItems: "center", justifyContent: "center" }}>
                <svg width="24" height="24" viewBox="0 0 24 24" fill="none"><circle cx="12" cy="12" r="4" fill="#1A1B1C"/><path d="M9 3h6l1.5 2H18a1 1 0 0 1 1 1v13a1 1 0 0 1-1 1H6a1 1 0 0 1-1-1V6a1 1 0 0 1 1-1h1.5L9 3Z" stroke="#1A1B1C" strokeWidth="1.5" strokeLinejoin="round"/></svg>
              </div>
            </div>
          )}
